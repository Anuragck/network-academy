                ...
                <div class="row">
                  <div class="col">
                    ...
                    <div class="form-group">
                      ...
                      <small
                        class="text-danger"
                        v-if="category_image_message != ''"
                      >
                        {{ category_image_message }}</small
                      >
                    </div>
  ...
  methods: {
    ...
    categoryImage(e) {
      ...
      if (e.target.files[0].size >= 4380793) {
        vm.category_image_message = "Size must not exceed 4.13 MB.";
        return false;
      }
